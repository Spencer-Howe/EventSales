...
SELECT 'Daniel Dayon', 'dayon7@gmail.com', NULL, '2025-12-06 18:01:22'
WHERE NOT EXISTS (
    SELECT 1 FROM customer WHERE email = 'dayon7@gmail.com'
);
...
VALUES (
    ...
    FALSE, 
    NULL, 
    (SELECT id FROM customer WHERE email = 'dayon7@gmail.com'),
    684,
    TRUE
);
...
VALUES (
    ...
    '2025-12-06 18:01:22',
    '6F32752922145734A',
    (SELECT id FROM booking WHERE order_id = '6F32752922145734A')
);
...
WHERE b.order_id = '6F32752922145734A';